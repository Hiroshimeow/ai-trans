...
const startIdx = 2011; // 0-indexed index of line 2012

const settingsLines = workspaceLines.slice(startIdx);
const imports = fs.readFileSync('imports.txt', 'utf-8');

fs.writeFileSync('app/src/main/java/com/example/ui/RecordingsTabContent.kt', 'package com.example.ui\n' + imports + '\n' + settingsLines.join('\n') + '\n');
...
console.log('done extraction recordings');
